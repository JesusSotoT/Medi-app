$(document).on('ready', function() {
    ...
    // --- OTROS ---
        ...
        // =================================== //
            ...
            $(".section--inicio").click(function(event) {                
                var topY = $("#inicio").offset().top;
                TweenLite.to($(window), 1, {delay:0.5,scrollTo:{y: topY-40, autoKill: true}, ease:Power3.easeInOut});
            });
            $(".section--medicos").click(function(event) {
                if($("#medicos").length){
                    var topY = $("#medicos").offset().top;
                    TweenLite.to($(window), 1, {delay:0.5,scrollTo:{y: topY-40, autoKill: true}, ease:Power3.easeInOut});
                }else{
                    window.location.href="home/#medicos";
                    /*window.location.href="/medicheck/home/#medicos";*/
                }
            });
            $(".section--pacientes").click(function(event) {
                if($("#pacientes").length){
                    var topY = $("#pacientes").offset().top;
                    TweenLite.to($(window), 1, {delay:0.5,scrollTo:{y: topY-40, autoKill: true}, ease:Power3.easeInOut});
                }else{
                    window.location.href="home/#pacientes";
                    /*window.location.href="/medicheck/home/#pacientes";*/
                }
            });
            $(".section--contacto").click(function(event) {
                if($("#contacto").length){
                    var topY = $("#contacto").offset().top;
                    TweenLite.to($(window), 1, {delay:0.5,scrollTo:{y: topY-40, autoKill: true}, ease:Power3.easeInOut});
                }else{
                    window.location.href="home/#contacto";
                    /*window.location.href="/medicheck/home/#contacto";*/
                }
            });        
});